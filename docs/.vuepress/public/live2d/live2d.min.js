    ...
    g.STATE_FIRST = "STATE_FIRST", g.STATE_INTERVAL = "STATE_INTERVAL", g.STATE_CLOSING = "STATE_CLOSING", g.STATE_CLOSED = "STATE_CLOSED", g.STATE_OPENING = "STATE_OPENING", _.mul = function (t, i, e) {
        ...
        for (var i = new l, e = c.getPlatformManager(), r = e.jsonParseFromBytes(t), o = r.physics_hair, n = o.length, s = 0; s < n; s++) {
            ...
            for (var f = _.src, d = f.length, g = 0; g < d; g++) {
                ...
                "x" === P ? T = PhysicsHair.Src.SRC_TO_X : "y" === P ? T = PhysicsHair.Src.SRC_TO_Y : "angle" === P ? T = PhysicsHair.Src.SRC_TO_G_ANGLE : UtDebug.error("live2dold", "Invalid parameter:PhysicsHair.Src");
            ...
            for (var L = _.targets, M = L.length, g = 0; g < M; g++) {
                ...
                "angle" === P ? T = PhysicsHair.Target.TARGET_FROM_ANGLE : "angle_v" === P ? T = PhysicsHair.Target.TARGET_FROM_ANGLE_V : UtDebug.error("live2dold", "Invalid parameter:PhysicsHair.Target");
    ...
    function s() {
        b || (b = !0, function t() {
            ...
            if (window.Live2D.captureFrame) {
                ...
                document.body.appendChild(e), e.setAttribute("type", "hidden"), e.href = C.toDataURL(), e.download = window.Live2D.captureName || "live2dold.png", e.click()
            }
            i(t, C)
        }())
    }
    ...
    (function (t) {
        !function () {
            ...
            St.prototype._$bT = function () {
                ...
                return this._$e0
            }, Et._$W2 = 0, Et.SYSTEM_INFO = null, Et.USER_AGENT = window.navigator.userAgent, Et.isIPhone = function () {
